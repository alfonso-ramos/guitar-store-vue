        ...
        <nav class="col-md-6 a mt-5 d-flex align-items-start justify-content-end">
          <div class="carrito">
            ...
            <div id="carrito" class="bg-white p-3">
              <p v-if="carrito.length === 0" class="text-center margin-0">
                    ...
                    <tr 
                      ...
                      <td class="flex align-items-start gap-4">
                        <button 
                          type="button" 
                          class="btn btn-dark"
                          @click="$emit('decrementar-cantidad', product.id)"
                        >-
                        </button>
                        {{ product.cantidad }}
                        <button 
                          type="button" 
                          class="btn btn-dark"
                          @click="$emit('incrementar-cantidad', product.id)">+</button>
                      </td>
                      <td>
                        <button 
                          class="btn btn-danger" 
                          type="button"
                          @click="$emit('eliminar-producto', product.id)"
                          >X</button>
                      </td>
                    </tr>
                  </tbody>
